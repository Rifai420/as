  ...
  <div class="col-12 col-md p-0 border">
    ...
    <div class="row no-gutters pt-2 pb-1 pb-md-0 bg-white">
  	  ...
  	  <div id="subscribe" class="col-12 col-md-4 d-flex justify-content-center justify-content-md-end align-items-start pr-1">
  		...
  		<button type="button" class="btn btn-sm  btn-primary btn-subscribe" data-action="del" data-user="<?php echo $this->video['user_id']; ?>"><i class="fa fa-user"></i> <?php echo __('unsubscribe'); ?> (<?php echo $this->video['subscribers']; ?>)</button>
  		<?php else: ?>
  		<button type="button" class="btn btn-sm btn-primary btn-subscribe" data-action="add" data-user="<?php echo $this->video['user_id']; ?>"><i class="fa fa-user"></i> <?php echo __('subscribe'); ?> (<?php echo $this->video['subscribers']; ?>)</button>
  		<?php endif; ?>
  	  </div>
    </div>
    <div class="d-flex justify-content-center justify-content-md-start flex-wrap pt-0 pb-1 pl-2 pr-2 bg-white border-bottom">
        ...
        <img src="<?php echo USER_URL,'/',avatar(true); ?>" " class="rounded" width="40"> 
		<a href="<?php echo REL_URL,'/users/',e($this->video['username']); ?>/"> <strong><?php echo e($this->video['username']); ?></strong> </a>
		



	 </div>
  	  <div class="content-details text-muted mr-4 mt-2 ">
    ...
    <div class="row no-gutters py-2 border-bottom">
  	  ...
  	  <div class="col-12 col-md-4 text-center text-md-left">
  		<?php $percent = ($this->video['likes'] > 0 && $this->video['rated_by']) ? round($this->video['likes']*100/$this->video['rated_by']) : 0; ?>
  		<div class="d-flex justify-content-center justify-content-md-start">
  		  ...
  		  <div id="rating" class="votes p-1 pt-2"><?php echo $percent; ?>% 

  		  </div>
  		  <button type="button" class="btn btn-action btn-thumbs-down btn-rate-video mr-1" data-rating="0" data-toggle="tooltip" data-placement="top" title="<?php echo __('i-dislike-this'); ?>"><i id="thumbs-down" class="fa fa-thumbs-down fa-flip-horizontal"></i></button>
	  ...
	  <div class="tabs-content mt-2" id="videoTabsContent">
		...
		<div class="tab-section d-block" id="related-videos">
		  <?php if ($this->related): ?>
      	  ...
      	  <div class="text-center"><button class="btn btn-lg btn-primary  w-50 my-2" id="related-more" data-page="2"><i class="fa fa-spinner"></i> <strong><?php echo __('more-related-videos'); ?></strong></button></div>
      	  <?php endif; else: ?>
